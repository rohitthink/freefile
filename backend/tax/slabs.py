...
REBATE_87A_NEW = {
    "limit": 1200_000,   # Taxable income up to 12,00,000
...
STANDARD_DEDUCTION_NEW = 75_000  # FY 2025-26
...
DEDUCTION_LIMITS = {
    ...
    "80CCD_2": None,       # Employer NPS (14% of salary) - no absolute limit
    ...
    "80G": None,           # Donations - varies by org (50% or 100%)
...
INTEREST_234A = 0.01  # 1% per month for late filing
INTEREST_234B = 0.01  # 1% per month for default on advance tax
INTEREST_234C = 0.01  # 1% per month for deferment of advance tax
